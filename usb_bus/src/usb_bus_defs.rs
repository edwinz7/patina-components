...
use core::{cell::Cell, mem::offset_of, ptr};
...
pub struct UsbDevice {
    ...
    pub translator: Usb2HcTransactionTranslator,
...
pub struct UsbInterface {
    ...
    pub is_hub: bool,
    pub hub_api: Option<&'static UsbHubApi>,
    pub num_of_port: u8,
...
#[derive(Clone, Copy)]
pub struct UsbHubServices {
    pub protocols: &'static dyn ProtocolServices,
    pub agent: Handle,
    pub events: &'static dyn EventServices,
    pub timers: &'static dyn TimerEventServices,
    pub timing: &'static dyn TimingServices,
    pub tpl: &'static dyn TplServices,
    pub drivers: &'static dyn DriverServices,
}
...
pub struct UsbBus {
    ...
    pub hub_services: UsbHubServices,
